...
const CACHE_NAME   = 'nearzone-v5';
const RUNTIME_CACHE = 'nearzone-runtime-v5';

/* ── Assets to pre-cache on install ── */
const PRECACHE_URLS = [
  '/Nearzone/',
  '/Nearzone/index.html',
  '/Nearzone/manifest.json',
  '/Nearzone/sw.js',
...
async function networkFirst(request) {
  try {
    ...
    const cached = await caches.match(request);
    return cached || await caches.match('/Nearzone/') || new Response(offlinePage(), {
